...
volScalarField::DimensionedInternalField * fvMesh::get_VPtr()
{
    return static_cast<slicedVolScalarField::DimensionedInternalField*>(VPtr_);
}


volScalarField::DimensionedInternalField * fvMesh::get_VPtr() const
{
    return static_cast<slicedVolScalarField::DimensionedInternalField*>(VPtr_);
}
...
surfaceVectorField * fvMesh::get_SfPtr()
{
    return SfPtr_;
}


surfaceVectorField * fvMesh::get_SfPtr() const
{
    return SfPtr_;
}
...
surfaceScalarField * fvMesh::get_magSfPtr()
{
    return magSfPtr_;
}


surfaceScalarField * fvMesh::get_magSfPtr() const
{
    return magSfPtr_;
}
...
volVectorField * fvMesh::get_CPtr()
{
    return CPtr_;
}


volVectorField * fvMesh::get_CPtr() const
{
    return CPtr_;
}
...
surfaceVectorField * fvMesh::get_CfPtr()
{
    return CfPtr_;
}


surfaceVectorField * fvMesh::get_CfPtr() const
{
    return CfPtr_;
}
